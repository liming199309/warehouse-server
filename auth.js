...
function signToken(user) {
  const payload = { username: user.username, name: user.name, role: user.role, roleKey: user.roleKey, perms: user.perms, exp: Date.now() + EXPIRE }
...
module.exports = { signToken, verifyToken, authRequired, requirePerm, login }
